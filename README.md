...
Since we are using IPFS network for saving files, you must install IPFS before running the project. 
Follow these instructions to install IPFS.
...
To optimize the proxiKYC application for production, run:
